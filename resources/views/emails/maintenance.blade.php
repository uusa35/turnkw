...
<head>
    ...
    <title> Contact Us | turnkw | {{ $data['subject'] }}</title>
    <style type="text/css">
        body {
                                                            ...
                                                            <td>
                                                                <div class='contentEditableContainer contentTextEditable'>
                                                                    <div class='contentEditable'
                                                                        ...
                                                                        <h2 style="font-size: 20px;">{{ (trans('general.create_maintenance')) }}</h2>
                                                                        <br>
                                                                        <table>
                                                                            <tr>
                                                                                <td>Company Name : </td>
                                                                ...
                                                                <div class='contentEditableContainer contentTextEditable'>
                                                                    <div class='contentEditable'
                                                                        ...
                                                                        <p> turnkw <br/>
                                                                            Kuwait<br/>
                                                                            <br/>
                                                                            <a href="http://turnkw.com">turnkw</a>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
